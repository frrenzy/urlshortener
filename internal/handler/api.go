...
func (s apiHandler) createShortJSON(ctx context.Context) http.HandlerFunc {
...
func newAPIRouter(ctx context.Context, services Services) chi.Router {
	router := chi.NewRouter()
	apiHandlers := apiHandler{Services: services}

	router.Route(`/`, func(r chi.Router) {
		r.Post(`/shorten`, apiHandlers.createShortJSON(ctx))
	})
